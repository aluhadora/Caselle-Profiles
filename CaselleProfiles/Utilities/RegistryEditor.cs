...
namespace CaselleProfiles.Utilities
{
  public class RegistryEditor
  {
    ...
    private const string SubKeyLocation = "SOFTWARE\\Aluhadora\\CaselleProfiles";
    ...
    {
      get { return SubKeyLocation + Separator + ProfileName; }
    }
    ...
    public IList<string> ReadKeys()
    {
      var rk = _baseRegistryKey;
      var sk1 = rk.OpenSubKey(SubKeyLocation);
